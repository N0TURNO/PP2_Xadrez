...
//Construtor de pecas
PecaXadrez* CriaPecaXadrez(int posicaoIX, int posicaoIY, Cor cor, PecaTipo tipo);
...
int BucaPosicaoPeca_X(PecaXadrez *peca);
int BucaPosicaoPeca_Y(PecaXadrez *peca);
...
Cor BucasCorPeca(PecaXadrez *peca);
...
Boolean ModificaEstadoPeca(PecaXadrez *peca);
